        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-sm btn-flat float-right" href="{{route('users.add')}}"><i class="fas fa-plus-circle"></i> Create</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach($users as $row)
                                <tr>
                                    ...
                                    <td><a href="{{route('users.view', $row->id)}}">{{$row->name}}</a></td>
                                    <td>{{$row->email}}</td>
                                    ...
                                    <td>{{ $user_type }}</td>
                                    <td>
                                        <a class="btn btn-info btn-sm btn-flat" href="{{route('users.edit', $row->id)}}">
