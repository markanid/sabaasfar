        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('categories.index')}}">{{$page}}</a></li>
...
<div class="card card-primary card-outline">
    <div class="card-header">
        ...
        <a class="btn btn-dark btn-sm btn-flat float-right" href="{{route('categories.index')}}"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
    </div>
            ...
            <div class="row">                
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" tabindex="1" class="form-control" value="{{ !empty($category->name) ? $category->name : '' }}">
                        @if ($errors->has('name'))
